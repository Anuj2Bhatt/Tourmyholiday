...
router.get('/:subdistrictId', async (req, res) => {
  try {
    ...
    console.error('Error fetching territory subdistrict images:', error);
...
router.post('/:subdistrictId', upload.single('image'), async (req, res) => {
  try {
    ...
    console.error('Error adding territory subdistrict image:', error);
...
router.put('/:imageId', upload.single('image'), async (req, res) => {
  try {
    ...
    console.error('Error updating territory subdistrict image:', error);
...
router.delete('/:imageId', async (req, res) => {
  try {
    ...
    console.error('Error deleting territory subdistrict image:', error);
